...
Proyecto realizado como trabajo final del curso **Back-End Java de Talento Tech Buenos Aires**.

---

## Descripción

TurnoSalud API permite administrar información relacionada con la asignación de turnos para prácticas de diagnóstico por imágenes.

La aplicación permite:

* Registrar, consultar, actualizar y eliminar pacientes.
* Registrar y administrar prácticas médicas.
